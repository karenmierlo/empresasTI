...
| Atividades a serem realizadas ⚠ | Criação DashBoards dos resultados da pesquisa| Auxílio na construção do código, Discussão com a equipe sobre os dados coletados,  Seleção das informações que integrarão os dashboards  | Construção do código para tratamento dos dados do Questionário | Montagem do script da gravação | | |
