...
| Atividades realizadas Sprint10 ✅| |Realização das reuniões diárias com a equipe, Seleção das informações que integrarão os dashboards, Elaboração da análise dos resultados |Serialização e estudo do segundo arquivo.csv, que foi conseguido por meio de uma pesquisa com os alunos do Entra21, Construção do código do tratamento dos dados (mysql) | |Análise da fonte de dados, revisão de dashboards | |
