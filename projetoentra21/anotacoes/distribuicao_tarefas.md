...
| Atividades realizadas Sprint9 ✅ | |Realização das reuniões diárias com a equipe, Auxílio na construção do código, Discussão com a equipe sobre os dados coletados |Finalização da serialização do arquivo.csv, que conhtém os dados referêntes aos benefícios das empresas. Posteriormente os mesmos foram gravados em um banco mysql | | | |
