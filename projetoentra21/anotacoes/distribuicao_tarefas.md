...
| Atividades realizadas Sprint8 ✅ | |Realização das reuniões diárias com a equipe |Continuidade e testes na serialização do csv no Pandas, melhoramentos nos desenvolvimentos dos códigos | | | |
| Atividades realizadas Sprint9 ✅ | |Realização das reuniões diárias com a equipe, Auxílio na construção do código, Discussão com a equipe sobre os dados coletados |Finalização da serialização do arquivo.csv, que contém os dados referêntes aos benefícios das empresas. Posteriormente os mesmos foram gravados em um banco mysql | | | |
| Atividades realizadas Sprint10 ✅| |Realização das reuniões diárias com a equipe, Seleção das informações que integrarão os dashboards, Elaboração da análise dos resultados |Serialização e estudo do segundo arquivo.csv, que foi conseguido por meio de uma pesquisa com os alunos do Entra21, Construção do código do tratamento dos dados (mysql) | | | |
| Atividades realizadas Sprint11 ✅| |Realização das reuniões diárias com a equipe, Definição do nome do Grupo para o dia de apresentação na Mostra de Talentos | Melhorias e ajustes no código (python) do tratamento dos dados (mysql)| | | |
