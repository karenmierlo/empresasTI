...
| Atividades realizadas Sprint12 ✅| |Realização das reuniões diárias com a equipe, Revisão do roteiro de gravação, Pitch do projeto 30' publicado no Linkedin |Melhorias e ajustes no código, participação nas gravações dos áudios para o Pitch de 3 min. | | | |
| Atividades a serem realizadas ⚠ | Criação DashBoards dos resultados da pesquisa| Reunião pré-apresentação final  | Reunião pré-apresentação final| Montagem do script da gravação | Atualização de novos dados para o dashboard e aprimorar o visual | |
