...
| Atividades a serem realizadas ⚠ | Realizar a criação do DashBoard com os resultados da pesquisa | Pesquisar Webscrapping e transposição de dados da tabela | Webscrapping do Linkedin, Construção do código e envio para nuvem | Montagem do script da gravação, Organizar read me, main.py. a pessoa tem que olhar e entender | |  |
