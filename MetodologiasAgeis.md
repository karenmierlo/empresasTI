...
| Atividades a serem realizadas ⚠ | | Pesquisar Webscrapping e transposição de dados da tabela | Webscrapping do Linkedin, Construção do código e envio para nuvem, Tabela Empresa x Beneficios servidor nuvem (Python + SQL) | Montagem do script da gravação, Organizar read me, main.py. a pessoa tem que olhar e entender | |  |
